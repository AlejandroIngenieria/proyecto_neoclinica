...
export const styles = sortCx({
    ...
    colors: {
        gray: {
            root: "bg-white text-slate-700 dark:bg-slate-800 dark:text-slate-200 shadow-xs ring-1 ring-slate-200 dark:ring-slate-700 ring-inset hover:bg-slate-50 dark:hover:bg-slate-750",
            icon: "text-slate-500",
        },
        black: {
            root: "bg-black text-white shadow-xs ring-1 ring-transparent ring-inset hover:bg-slate-900",
            icon: "",
        },

        facebook: {
            root: "bg-[#1877F2] text-white shadow-xs ring-1 ring-transparent ring-inset hover:bg-[#0C63D4]",
            icon: "",
        },

        dribble: {
            root: "bg-[#EA4C89] text-white shadow-xs ring-1 ring-transparent ring-inset hover:bg-[#E62872]",
            icon: "",
        },
    },
});
