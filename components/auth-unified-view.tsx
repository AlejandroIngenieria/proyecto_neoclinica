                  ...
                  <div className="flex w-full flex-col gap-2.5 mb-3">
                    ...
                    {socialLoading === 'google' ? (
                      <div
                        ...
                        className="relative flex h-11 w-full items-center rounded-xl border border-blue-200 dark:border-blue-800/60 bg-blue-50/40 dark:bg-blue-950/20 shadow-xs transition-all duration-150"
                      >
                        ...
                        {/* Mensaje breve en el centro */}
                        <span className="w-full text-center text-xs sm:text-sm font-semibold text-slate-700 dark:text-slate-200 pl-9 pr-20 select-none">
                          Ventana abierta...
                        </span>
                        {/* Iconos de acción a la derecha: Reintentar y Cancelar */}
                        <div className="absolute right-2 flex items-center gap-0.5">
                          <button
                            type="button"
                            title="Reintentar inicio con Google"
                            aria-label="Reintentar inicio con Google"
                            onClick={() => {
                          ...
                          <button
                            type="button"
                            title="Cancelar"
                            aria-label="Cancelar inicio con Google"
                            onClick={() => {
                              isProcessingTokenRef.current = false;
                              resetSocialState();
                            }}
                            className="flex h-7 w-7 items-center justify-center rounded-lg text-slate-400 hover:text-rose-600 hover:bg-rose-100/70 dark:hover:bg-rose-900/50 active:scale-95 transition-all cursor-pointer"
                          >
                        ...
                        socialLoading === 'facebook' ? (
                          ...
                          >
                            ...
                            <div className="absolute right-2 flex items-center gap-0.5">
                              <button
                                type="button"
                                title="Reintentar inicio con Facebook"
                                aria-label="Reintentar inicio con Facebook"
                                onClick={() => {
                                  popupOpenTimeRef.current = Date.now();
                                  isProcessingTokenRef.current = false;
                                  setLoginAuthError('');
                              ...
                              <button
                                type="button"
                                title="Cancelar"
                                aria-label="Cancelar inicio con Facebook"
                                onClick={() => {
                                  isProcessingTokenRef.current = false;
                                  resetSocialState();
                                }}
